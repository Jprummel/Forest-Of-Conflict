...
public class InputAxes{
    //Face Buttons
    public const string button_a        = "Xbox_A";
    public const string button_b        = "Xbox_B";
    public const string button_x        = "Xbox_X";
    public const string button_y        = "Xbox_Y";
    //Start and back
    ...
    //Analog Clicks
    public const string l3              = "Xbox_L3_";
    public const string r3              = "Xbox_R3_";
    //Analog Sticks
    //Left
